...
def get_version():
  ...
  Returns:
      (str): The version number extracted from the '__version__' attribute in the 'ultralytics'
  """
...
def parse_requirements(file_path: Path):
  """
  Parse a requirement.txt file , ignoring lines that start with '#' and any text after '#'
  Args:
  file_path(str | Path): Path to the requirement.txt file.
...
setup(
  ...
  extras_require={
    'dev': [
        ...
        'mkdocs-redirects',
        'mkdocs-ultralytics-plugin>=0.0.32',
  ...
  classifiers = [
      ...
      'License :: OSI Approved :: GNU Affero General Public License v3 or later (APGLv3+)',
      'Programming Language :: Python :: 3',
      'Programming Langugae :: Python :: 3.8',
